...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex align-items-center justify-content-center justify-content-md-between">
      ...
      <div class="d-flex align-items-center">
        <i class="bi bi-phone"></i> Hubungi Kami +62 0822 XXXX XXXX
      </div>
    </div>
  </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="#appointment" class="appointment-btn scrollto"><span class="d-none d-md-inline">Berlangganan</span> Sekarang</a>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      ...
      <center><img src="assets/img/logo.png" style="max-width:200px;"></center>
    ...
    <section class="inner-page">
      <div class="container">
        ...
        <p align="justify">
			...
			<br>
			<br>
			<b>Akses ke Data Pribadi Anda</b>
			...
			Persetujuan Perubahan Kebijakan Privasi
			...
			<br>
			<br>
			<b>Kepatuhan Pada Proses Hukum</b>
